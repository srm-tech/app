        ...
        <div className='px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8'>
              ...
              <div className='mt-0 xl:mt-0'>
                ...
                >
                  ...
                  <div className='mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0'>
                    <button
                      type='submit'
                      className='flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white bg-primary-400 border border-transparent rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-green-500'
                    >
                      Subscribe
                    </button>
                  </div>
          ...
          <div className='pt-8 mt-8 border-t border-gray-700 md:flex md:items-center md:justify-between'>
            ...
            <p className='mt-8 text-base text-gray-400 md:mt-0 md:order-1'>
              &copy; 2021 Introduce Guru, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
