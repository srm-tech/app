    ...
    <main className='max-w-2xl m-auto'>
      <div className='container'>
        ...
        <div className='mb-5 mt-5 space-x-4'>
          <CustomLink href='/legal/terms'>Terms &amp; Conditions</CustomLink>
        ...
        <p>
          ...
          <a href='https://introduce.guru'>https://introduce.guru</a> and any
        ...
        <p>
          ...
          other services provided by INTRODUCE GURU.
        </p>
        <p>
          We, INTRODUCE GURU, reserve the right to review and amend any of these
        ...
        <ol className='list-disc ml-2'>
          ...
          <li>
            ...
            service INTRODUCE GURU provides;
          </li>
          <li>
        ...
        <p>
          ...
          are owned by or licensed to INTRODUCE GURU and are protected by
        ...
        <p>
          ...
          is' basis. To the extent permitted by law, INTRODUCE GURU makes no
        ...
        <p>
          In no event shall INTRODUCE GURU or its suppliers be liable for any
          ...
          on this website, even if INTRODUCE GURU or an authorized
        ...
        <p>
          ...
          for general information purposes only. INTRODUCE GURU does not warrant
        ...
        <h3>Links</h3>
        <p>
          INTRODUCE GURU has not reviewed all of the sites linked to its website
          and is not responsible for the contents of any such linked site. The
          inclusion of any link does not imply endorsement, approval, or control
          by INTRODUCE GURU of the site. Use of any such linked site is at your
          own risk and we strongly advise you make your own investigations with
          respect to the suitability of those sites.
        </p>
        <h3>Pay as you go (month to month)</h3>
        ...
        <p>
          ...
          cancel. We will automatically charge you the then-current rate for
          your plan, plus applicable taxes (such as VAT or GST if the rate does
          not include it), every month upon renewal until you cancel.
        </p>
        ...
        <p>
          Your subscription begins as soon as your initial payment is processed.
          You will be charged, in one lump sum, the annual rate stated at the
          time of purchase, plus applicable taxes. Your subscription will
          automatically renew on your annual renewal date until you cancel. You
          authorise us to store your payment method(s) and to automatically
          charge your payment method(s) every year until you cancel.
        </p>
        <h4>Cancellation Terms</h4>
        <p>
          You may cancel the Services by providing us with no less than 30 days
        ...
        <p>
          Unless you’re in a free trial or other offer period, you’ll need to
          pay for a subscription based on the pricing of your selected plan. The
          pricing details and other terms of your subscription are explained
          when you select your plan.
        </p>
        <p>
          If you choose to continue using our services after the trial, you’ll
          be billed when you add your billing details into our services.
        </p>
        <p>
          In order to continue accessing our services, you need to make timely
          payments based on the pricing plan you selected.
        </p>
        <p>
          ...
          payment methods in your account fail, we may suspend your
          subscription. You can edit your payment information any time in your
          Account's Billing page.
        </p>
        <h3>Right to Terminate by INTRODUCE GURU</h3>
        <p>
        ...
        <p>
          Once a subscription is terminated by you or us, it is archived and the
          data submitted or created by you is no longer available to you. We
          retain it for a period of time consistent with our data retention
          policy, during which, as a subscriber, you can reactivate your
          subscription and once again access your data by paying the
          subscription fees. You can get in touch with us to have your data
          removed completely if you wish.
        </p>
        <h3>Severance</h3>
        <p>
        ...
        <p>
          ...
          INTRODUCE GURU under any ongoing agreement. It’s designed to protect
          us, our customers, and the general Internet community from unethical,
          irresponsible, and illegal activity.
        </p>
        <p>
          INTRODUCE GURU customers found engaging in activities prohibited by
