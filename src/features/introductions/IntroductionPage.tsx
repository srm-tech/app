  ...
  async function loadUser() {
    ...
    if (response.ok) {
      ...
      setFormValues({
        ...
        commissionPerReceivedLead: data.commissionPerReceivedLead,
        commissionPerCompletedLead: data.commissionPerCompletedLead,
        commissionPerCompletedLeadPercent:
          data.commissionPerCompletedLeadPercent,
        isAcceptingIntroductions: data.isAcceptingIntroductions,
      });
    }
  }
